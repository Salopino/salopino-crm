...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ marginTop: 0, marginBottom: 14, fontSize: 26 }}>Ota yhteyttä tänään</h2>
            ...
            {contactsToday.map((client) => (
              <div
                ...
                style={{
                  ...
                  borderLeft: `5px solid ${STATUS_COLORS[client.status] || "#6b7280"}`,
                  borderRadius: 12,
                  padding: 16,
                }}
              >
      ...
      >
        <h2 style={{ marginTop: 0, marginBottom: 18, fontSize: 26 }}>Lisää uusi case</h2>
      ...
      {viewMode === "table" ? (
        ...
        >
          <h2 style={{ marginTop: 0, marginBottom: 18, fontSize: 24 }}>Myyntitaulukko</h2>
        ...
        >
          <h2 style={{ marginTop: 0, marginBottom: 18, fontSize: 24 }}>Kanban-putki</h2>
